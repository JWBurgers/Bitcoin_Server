...
This setting is a good starting point for your configurations. To ensure the options are indeed set as above by default, you can execute the following two instructions:
